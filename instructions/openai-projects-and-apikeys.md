...
3. [What Are Projects?](#what-are-projects)
...
4. [How API Keys and Projects Work Together](#how-api-keys-and-projects-work-together)
   1. [Example Use Case](#example-use-case)
   2. [Best Practices for API Keys and Projects](#best-practices-for-api-keys-and-projects)
